...
def team_season(request, team, season):
	...
	games = Game.objects.filter(Q(season=season) & (Q(home_team=team) | Q(away_team=team)))\
		.values('game_date', 'competition', 'neutral_venue', 'home_team', 'away_team', 'home_score', 'away_score')\
	...
	for game in games:
		...
		if game['home_team'] == team.id:
			if game['neutral_venue'] == True:
				details = {"venue": "N", "competition": game['competition'], "team": game['home_team'], "opponent": game['away_team'],
		...
		# If the chosen team was away, allocate the away team's result to them and set the home team as their opponent.
			...
			if game['neutral_venue'] == True:
				details = {"venue": "N", "competition": game['competition'], "team": game['away_team'], "opponent": game['home_team'],
